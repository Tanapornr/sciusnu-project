...
- นักเรียน: `68983244` / `1234` แล้วระบบจะให้เปลี่ยนรหัสผ่านเมื่อเข้าใช้ครั้งแรก
...
- ถ้าเว้นรหัสผ่านนักเรียนว่าง ระบบจะ Gen Password แบบตัวเลข 4 ตัวให้อัตโนมัติ
- นักเรียนที่ได้รหัสผ่านจากระบบต้องเปลี่ยนรหัสผ่านเองเมื่อเข้าใช้งานครั้งแรก
- ปุ่ม `Gen Password นักเรียนจากโครงงาน` จะอ่านรหัสนักเรียนใน `NEW_Projects` แล้วสร้างบัญชีใน `NEW_Users` พร้อมตั้งค่าให้เปลี่ยนรหัสผ่านครั้งแรก
